...
async function runRetrospectiveUpdates() {
    try {
        console.log("[Retrospective Sync] Triggering schema and catalog sync on backend...");
        await adminApiCall("/admin/sync-schemas", "POST");
        console.log("[Retrospective Sync] Database schema sync successful.");
    } catch (err) {
